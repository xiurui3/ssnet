...
def main():
    ...
    image = sitk.ReadImage('Pancreas04.nii.gz')
    label = sitk.ReadImage('label0004.nii.gz')
    ...
    sitk.WriteImage(fg_image, 'Pancreas04-1.nii.gz')
    fg_label.SetDirection(label_t.GetDirection())
    fg_label.SetSpacing(label_t.GetSpacing())
    sitk.WriteImage(fg_label,'label0004-1.nii.gz')
